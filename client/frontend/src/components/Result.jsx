...
const PromtResult = () => {
    ...
    const [image, setImage] = useState(assets.tech)
  ...
  return (
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
        <input onChange={e => setInput(e.target.value)} value={input} type='text' placeholder='Describe your song idea' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20'/>
